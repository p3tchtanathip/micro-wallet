...
public class WithdrawCommandValidatorTests
{
    ...
    {
        var command = new WithdrawCommand(walletId, 100);
        var result = _validator.TestValidate(command);
    ...
    {
        var command = new WithdrawCommand(1, amount);
        var result = _validator.TestValidate(command);
    ...
    {
        var command = new WithdrawCommand(1, 100, null);
        var result = _validator.TestValidate(command);
    ...
    {
        var command = new WithdrawCommand(1, 100, new string('a', 200));
        var result = _validator.TestValidate(command);
    ...
    {
        var command = new WithdrawCommand(1, 100, new string('a', 201));
        var result = _validator.TestValidate(command);

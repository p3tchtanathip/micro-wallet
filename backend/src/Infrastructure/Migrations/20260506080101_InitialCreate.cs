    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_transaction_entries", x => new { x.TransactionId, x.WalletId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_transaction_entries_wallets_WalletId",
                        column: x => x.WalletId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_transaction_entries_WalletId",
